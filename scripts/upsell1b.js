...
const UPSELL_NEXT_PAGE_SLUG = "2/order/de/eu/thank-you";
    ...
    const response = await fetch(
      `https://app-cms-api-proxy-prod-001.azurewebsites.net/vrio/order_offers`,
      {
        ...
        body: JSON.stringify({
          ...
          order_id: lastOrderId,
          pageId: "skJp6PjOKpIHs0j38GnBlWodR3n42zT_2zG4r4YVlIB_nLKt058gc9zNBvjQGNMc"
        })
      }
    );
...
const processUpsell = async () => {
  ...
  try {
    const orderData = JSON.parse(sessionStorage.getItem("orderData"));
    orderData.pageId = "skJp6PjOKpIHs0j38GnBlWodR3n42zT_2zG4r4YVlIB_nLKt058gc9zNBvjQGNMc";
    const lastOrderId = sessionStorage.getItem("cms_oid");
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "ADT-Downsell-German", pageType: "Upsell" },
    };
